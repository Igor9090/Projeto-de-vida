...
const tempoObjetivo3 = new Date("2025-01-30T00:00:00");
const tempoObjetivo4 = new Date("2025-02-10T00:00:00");
...
function atualizaConometro() {
  ...
  document.getElementById("dias0").textContent = calcularTempo(tempos[0] [1]);
  document.getElementById("horas0").textContent = calcularTempo(tempos[0] [2]);
  document.getElementById("min0").textContent = calcularTempo(tempos[0] [3]);
  document.getElementById("seg0").textContent = calcularTempo(tempos[0] [4]);
